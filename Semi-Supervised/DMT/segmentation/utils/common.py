...
base_galax = "/opt/TFM/DATASETS/new_subset_usss"
# base_galax = "/home/ubuntu/JM/DATASETS/new_subset_usss"
...
# For PASCAL VOC 2012
sizes_galax = [(128, 128), (256, 256), (256, 256)]  # training resize min/training resize max/testing label size
num_classes_galax = 2 # sky background is considered a class (sky=1, galax=0) 
colors_galax = [[0, 0, 0],
              [255, 255, 255]]
categories_galax = ['Background','Galaxy'] # 0 = backgr, 1=sky (12-Agosto)
    ...
    with torch.no_grad():
        for images, file_name_lists, heights, widths in tqdm(loader):
            ...
            for i in range(0, len(file_name_lists)):
                ...
                # JM: maybe directory for pseudo labels needs to be created ??
